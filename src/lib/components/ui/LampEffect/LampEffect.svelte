<script lang="ts">
    ...
    import { cn } from "$lib/utils"; // Assuming utils is in $lib/utils or verify path
...
>
    ...
    >
        ...
        >
            <div
                use:motion
                class="bg-gradient-conic absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible from-primary via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
            >
                <div
        ...
        >
            <div
                ...
                class="bg-gradient-conic absolute inset-auto left-1/2 h-56 w-[30rem] from-transparent via-transparent to-primary text-white [--conic-position:from_290deg_at_center_top]"
            >
                <div
        ...
        >
            <div
                use:motion
                class="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-primary blur-2xl"
            ></div>
        </Motion>
        <Motion
            let:motion
        ...
        >
            <div
                use:motion
                class="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-primary"
            ></div>
        </Motion>
