                ...
                >
                    <div class="form-control sm:col-span-2">
                        <label class="label" for="create-prompt"
                            ><span class="label-text">Prompt / Question</span
                            ></label
                        >
                        <textarea
                            id="create-prompt"
                    ...
                    <div class="form-control">
                        <label class="label" for="create-answer"
                            ><span class="label-text">Answer (lowercase)</span
                            ></label
                        >
                        <input
                            id="create-answer"
                    ...
                    <div class="form-control">
                        <label class="label" for="create-level"
                            ><span class="label-text">Level Number</span></label
                        >
                        <input
                            id="create-level"
                            name="level"
                        ...
                        <tr class="bg-base-200">
                            <td colspan="5">
                                <form
                                    ...
                                    action="?/update"
                                    use:enhance
                                    class="grid grid-cols-1 sm:grid-cols-2 gap-3 p-2"
                                >
                                    <input
                                        type="hidden"
                                        name="id"
                                    ...
                                    <div
                                        class="sm:col-span-2 flex gap-2 justify-end"
                                    >
                                        <button
                                            type="button"
                    ...
                    {:else}
                        <tr>
                            <td
                                ...
                                ></td
                            >
                            <td class="max-w-xs truncate" title={q.prompt}
                                >{q.prompt}</td
                            >
                            <td
                                ><code
                                    class="bg-base-300 px-2 py-0.5 rounded text-success"
                                    >{q.answer}</code
                                ></td
                            >
                            <td
                                class="max-w-xs truncate text-base-content/60"
